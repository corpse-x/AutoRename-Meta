...
class Database:
    def __init__(self, uri, database_name):
        ...
        self.autorenameDB = self._client[database_name]
        self.col = self.autorenameDB.user
...
autorenameDB = Database(Config.DB_URL, Config.DB_NAME)
